          ...
          data: (s) => BennetScaffold(
            ...
            body: LayoutBuilder(
              builder: (context, constraints) {
                final cards = <Widget>[
                  _metricCard(context, 'Opening balance', formatMoney(s.openingMinor)),
                  _metricCard(
                    context,
                    'Total income',
                  ...
                  _metricCard(context, 'Closing balance', formatMoney(s.closingMinor)),
                ];
                ...
                return ListView(
                  ...
                  children: [
                    ...
                    if (!twoCol)
                      ...cards.map((w) => Padding(padding: const EdgeInsets.only(bottom: 8), child: w))
                    else
                      Wrap(
                        spacing: 16,
                        runSpacing: 16,
                        children: cards.map((w) => SizedBox(width: cellW, child: w)).toList(),
                      ),
